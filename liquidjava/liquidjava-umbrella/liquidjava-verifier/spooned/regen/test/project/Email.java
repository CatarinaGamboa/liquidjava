...
public class Email {
    ...
    @liquidjava.specification.RefinementPredicate("boolean emptyEmail(Email e)")
    @liquidjava.specification.StateRefinement(to = "emptyEmail(this)")
    public Email() {
        receiver = new java.util.ArrayList<>();
    }

    @liquidjava.specification.RefinementPredicate("boolean senderSet(Email e)")
    @liquidjava.specification.StateRefinement(from = "emptyEmail(this)", to = "senderSet(this)")
    public void from(java.lang.String s) {
        sender = s;
    }

    @liquidjava.specification.RefinementPredicate("boolean receiverSet (Email e)")
    ...
    @liquidjava.specification.RefinementPredicate("boolean bodySet(Email e)")
