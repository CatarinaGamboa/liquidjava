...
public class Car {
    @liquidjava.specification.Refinement("IntBetween(_, 1800, 2050)")
    private int year;

    private boolean isOpen;

    public void setYear(@liquidjava.specification.Refinement("IntBetween(_, 1900, 2010)")
    int year) {
        this.year = year;
    }
    ...
    @liquidjava.specification.Refinement("_ == (this.year > c.year))")
