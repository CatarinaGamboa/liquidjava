...
public class GhostFunction {
  ...
  public GhostFunction(GhostDTO f, Factory factory, String path, String klass) {
    name = f.getName();
    return_type =
        Utils.getType(f.getReturn_type().equals(klass) ? path : f.getReturn_type(), factory);
  ...
  public GhostFunction(
    ...
    this.return_type =
        Utils.getType(
            return_type.toString().equals(klass) ? path : return_type.toString(), factory);
  ...
  protected GhostFunction(
      String name, List<CtTypeReference<?>> list, CtTypeReference<?> return_type, String klass) {
    this.name = name;
