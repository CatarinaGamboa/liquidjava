...
public class ErrorHandler {
  ...
  public static <T> void printError(
    ...
    String resumeMessage =
        "Type expected:" + expectedType.toString(); // + "; " +"Refinement found:" +
    // cSMT.toString();
  ...
  public static void printStateMismatch(
    ...
    String resumeMessage =
        "Failed to check state transitions. " + "Expected possible states:" + states; // + ";
    // Found
  ...
  public static void printErrorConstructorFromState(
      CtElement element, CtLiteral<String> from, ErrorEmitter errorl) {
    StringBuilder sb = new StringBuilder();
    sb.append("______________________________________________________\n");
    String s =
        " Error found constructor with FROM state (Constructor's should only have a TO state)\n\n";
    sb.append(s);
    sb.append(element + "\n\n");
  ...
  public static void printSyntaxError(
      String msg, String ref, CtElement element, ErrorEmitter errorl) {
    StringBuilder sb = new StringBuilder();
    sb.append("______________________________________________________\n");
    StringBuilder sbtitle = new StringBuilder();
