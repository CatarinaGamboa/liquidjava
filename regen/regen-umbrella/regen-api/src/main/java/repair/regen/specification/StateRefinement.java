 ...
 * The annotation has two arguments:
 * from : the state in which the object needs to be for the method to be invoked correctly
 * to	: the state in which the object will be after the execution of the method
